      ...
      <div className="stack">
        <section className="panel">
          ...
          <p className="help-copy" style={{ marginBottom: 18 }}>
            Tóm lược theo định dạng VSTEP bậc 3–5 do Trường ĐH Ngoại ngữ, ĐHQGHN
            công bố và đối chiếu với nguồn tại ĐH Sư phạm TP.HCM ngày
          ...
          <p className="help-copy">
            Đề luyện đủ cấu trúc hiện có của Mây dùng khoảng 1.900–2.050 từ cho
            phần Reading, nằm trong phạm vi công bố trên.
          </p>
        </section>
