...
| F11 | Đã phát hành phần kỹ thuật | Câu hỏi có trường `evidence` và `optionNotes`; vòng chữa bài hiện câu bằng chứng, lý do phương án đã chọn sai, lý do đáp án đúng và phân tích các phương án còn lại, kèm nút nghe lại câu bằng chứng cho Listening. Phủ 56/111 câu; 55 câu riêng của đề đầy đủ và phần thẩm định của giáo viên vẫn mở. | P1-03 |
...
| F13 | Đã đo, còn lệch | Phân bố dạng câu vẫn lệch dù 20 câu Đọc mới đã bổ sung 2 câu Ý chính, 2 câu Mục đích tác giả, 1 câu Từ tham chiếu và 1 câu Từ vựng: phần Đọc của đề còn 22/40 câu “Thông tin chi tiết”, 2 câu từ vựng trong ngữ cảnh và 1 câu từ tham chiếu; phần Nghe vẫn 29/35 câu chi tiết. Cần ma trận dạng câu trước khi mở rộng ngân hàng. | P1-01/P1-04 |
