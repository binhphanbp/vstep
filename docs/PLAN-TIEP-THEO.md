...
| **UAT trên đúng điện thoại Gùa**                                                   | Cần thiết bị thật và thời gian của hai người. _(Diễn tập khôi phục đã được tự động hoá thành một ca E2E: xuất bản sao, xoá sạch máy, nhập lại, kiểm lịch sử.)_ |
