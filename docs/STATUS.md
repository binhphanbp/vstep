...
Cả sáu đợt của [PLAN-2026-09-14.md](PLAN-2026-09-14.md) đã xong; kế hoạch đang chạy là [PLAN-TIEP-THEO.md](PLAN-TIEP-THEO.md), đợt 1 (so sánh hai lần thi, kế hoạch dùng đúng ngân sách), đợt 2 (ngân hàng Viết/Nói) đợt 3 (thẻ từ mọc từ bài học, khoá chống tài liệu trôi) và đợt 4 (chú giải bằng chứng phủ hết 258 câu) đã xong. Ghi lại bối cảnh của kế hoạch 14/09: Ba phát hiện chính: kế hoạch ngày chỉ chọn được trong 141 phút bài (13/14 bài thư viện vừa ngân sách 30 phút), tức khoảng 5 ngày là hết bài mới; `skillStats` trộn lượt đầu với lượt làm lại nên độ chính xác tăng giả khi luyện lại; và thẻ trong Sổ lỗi không bao giờ rời sổ, kể cả khi câu đó đã được làm lại đúng.

Sau kế hoạch, ba việc vốn "chờ người" đã được rút xuống còn một thao tác mỗi việc: `/review-pack/bank` in được sáu tập hồ sơ học liệu (ngữ liệu, câu hỏi, đáp án có đánh dấu, ô trống cho người chấm) để nhờ giáo viên duyệt; Cài đặt có nút **Gửi báo lỗi** đưa thẳng bản mô tả vào khay chia sẻ hoặc clipboard của điện thoại; và `scripts/vercel-ignore-build.mjs` chặn build production khi CI của đúng SHA chưa xanh — script đã có trong repo nhưng **chưa được bật trên Vercel**. [UAT-DIEN-THOAI.md](UAT-DIEN-THOAI.md) là danh sách 20 mục để nghiệm thu trên máy Gùa; chưa ai chạy.
...
- Mây: giao diện responsive, dashboard cá nhân hóa, 42 bài luyện, hành trình, từ vựng, sổ lỗi, lịch sử, cẩm nang và cài đặt.
