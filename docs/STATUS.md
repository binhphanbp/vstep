...
- Sau đợt rà soát Reading/Listening: 47 kiểm thử Vitest và 30 kiểm thử Playwright trên `next start` đều đạt; suite đầy đủ chạy Chromium, toàn bộ tám bài Reading/Listening cùng luồng trọng yếu và tải backup chạy thêm Firefox/WebKit. ESLint, TypeScript, production build 45 route và axe trên 13 màn đều đạt. Chưa nghiệm thu thiết bị iOS/Android thật. Chi tiết lỗi đã sửa trong QUALITY.md.
